...
\graphicspath{{images/}{images/userguide/}{images/testing/}{images/infrastructure/}{extra/}}
...
\makeatother
\setlist{nolistsep} % Нет отступо между пунктами списка
...
\titleformat{\section}{}{}{12.5mm}{\centering{\thesection\quad\MakeTextUppercase{#1}}\vspace{2em}}
